...
\textit{Topi, Pakistan}
\begin{itemize}
  \item Teach HVAC, Engineering Dynamics, and CAD/CAM Lab to undergraduate
        students; conduct Thermofluids-I lab sessions and manage the Fluid
        Mechanics Laboratory.
  \item Serve as LMS Coordinator and support Outcome-Based Education mapping for
        courses aligned with Washington Accord standards.
  \item Supported institutional accreditation preparation through lab
        documentation, alumni surveys, and employer feedback.
  \item Organised the 6th International Workshop on Functional Reverse Engineering
        of Machine Tools (WRE~2024), including logistics and coordination.
\end{itemize}
...
\begin{itemize}
  \item Contributed to an HEC-funded project developing a flexible
        time-temperature indicator for food quality control and supported early
...
Leading the design of a large-scale water heating system integrated with solar PV.
Full technical specification and cost report in progress.
...
Other
  & Microsoft Office; Moodle LMS; OBE documentation; English C1 (CEFR) \\
\end{tabularx}
